...
export function buildPlantillaDeudaInicial(): XLSX.WorkBook {
  ...
  XLSX.utils.book_append_sheet(wb, sheet([
    ['N° Socio', 'Accionista', 'Concepto', 'Cuota', 'Multa'],
    ['1', 'JUAN PÉREZ SOTO', 'Deuda temporada 2023-2024', 480000, 240000],
    ['3', 'ANA DÍAZ ROJAS', 'Multa temporada 2024-2025', 0, 120000],
    [],
